...
(function() {
  ...
  describe('runtime', function() {
    ...
    it('should report fullfunction name in error', function(done) {
    ...
    it('should report the railed function calls w/multiple args', function(done) {
    ...
    it('should allow for objects without a prototype macro arguments in the last position', funciton(done) {
